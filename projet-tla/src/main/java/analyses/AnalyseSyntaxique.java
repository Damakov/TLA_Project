...
public class AnalyseSyntaxique {
	...
	/*
	 * effectue l'analyse syntaxique à partir de la liste de tokens et retourne le
	 * noeud racine de l'arbre syntaxique abstrait
	 */
...
// -------------------------Couloir-----------------------------------
	...
	private String C1() throws UnexpectedTokenException {
		...
		throw new UnexpectedTokenException(
				"Erreur de syntaxe, apres un Couloir il devrait y avoir une ligne, une colonne ou un end.");
	}
	...
	private String C2() throws UnexpectedTokenException {
		...
		throw new UnexpectedTokenException(
				"Erreur de syntaxe, apres une ligne ou une colonne il devrait y avoir une virgule.");
	}
