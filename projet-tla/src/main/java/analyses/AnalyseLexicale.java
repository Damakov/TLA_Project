...
public class AnalyseLexicale {
	...
	private static Integer TRANSITIONS[][] = {
			...
			/*  1 */    {	106, 106, 106, 106, 106, null,    1, null},
			/*  2 */    {	107, 107, 107, null, null, 107, null,    2}
		...
		do {
			...
			if (e >= 100) {
				if (e == 101) {
					...
					tokens.add(new Token(TypeDeToken.parouvrante));
				} else if (e == 103) {
					tokens.add(new Token(TypeDeToken.parfermante));
				} else if (e == 104) {
					tokens.add(new Token(TypeDeToken.pointvirgule));
				} else if (e == 105) {
					tokens.add(new Token(TypeDeToken.egal));
				} else if (e == 106) {
